...
class AddJob extends React.Component {
  ...
  render() {
    const { addJob, resetNewJobInput, newJob, handleNewJob, handleNewJobDate } =
      this.props;
    const disable =
      !newJob.customer || !newJob.source || !newJob.pay || !newJob.description;
    return (
      <div className="add-job-container">
        <div
          className="add-job-cell"
          style={{
            display: "flex",
            alignItems: "center",
